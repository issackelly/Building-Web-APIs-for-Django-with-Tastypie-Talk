...
(function($) {
	...
	function appendnote(note_data){
		...
		note_text_div = $('<div class="notep twipsy bottom" ><div class="twipsy-arrow"></div><div class="twipsy-inner">'+note_data.note+'</div>').css({ left: note_left + 'px', top: note_p_top + 'px'});
